...
// GetAgentAssignments gets the current assignment information for the given executor (aka agent)
...
// DedicateAgent assigns the given executor to the given entity
